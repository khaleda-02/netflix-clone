        ...
        <div className='max-w-[450px] h-[600px] mx-auto bg-black/75 text-white'>
          <div className='max-w-[320px] mx-auto py-16'>
            ...
            <form className='mt-4' onSubmit={handling}>
              ...
              <input onChange={(e) => setPassword(e.target.value)} type="password" placeholder="Password" className='py-2 w-full my-2 bg-gray-600 placeholder:pl-2 italic ' />
              <button className="bg-red-600 px-3 py-2 text-lg cursor-pointer w-full block my-2 ">Sign In </button>
            </form>
            ...
            <p className='text-gray-500 px-1 capitalize'>new to netflix
              <Link to='/signup'>
